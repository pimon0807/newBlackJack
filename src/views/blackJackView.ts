...
export class View {
  ...
  static createMainPage(table: BlackJackTable) {
    const container = document.createElement("div");
    container.classList.add(
      "vh-100",
      "bg-success",
                ...
                <div class="">
                    <div id="playersDiv" class="d-flex justify-content-between">
                        ...
                        <div id="${table.players[2]}" class="col-3">
                            ...
                            <p id="player2status" class="text-center">status: ${
                              table.players[2].status
                            }</p>
                            <p class="text-center">bet: ${
                              table.players[2].betAmount
                            }</p>
                            <p class="text-center">chip: ${
                              table.players[2].chips
                            }</p>
                        ...
                        <div id="player1info" class="col-3">
                            ...
                            <p id="player1status" class="text-center">status: ${
                              table.players[1].status
                            }</p>
                            <p class="text-center">bet: ${
                              table.players[1].betAmount
                            }</p>
                            <p class="text-center">chip: ${
                              table.players[1].chips
                            }</p>
                            <div class="d-flex justify-content-center row">
                        ...
                        <div id="${table.players[3]}" class="col-3">
                            ...
                            <p id="player3status" class="text-center">status: ${
                              table.players[3].status
                            }</p>
                            <p class="text-center">bet: ${
                              table.players[3].betAmount
                            }</p>
                            <p class="text-center">chip: ${
                              table.players[3].chips
                            }</p>
                            <div class="d-flex justify-content-center row">
  ...
  static createBetPhase(table: BlackJackTable) {
    const container = document.createElement("div");
    container.innerHTML = `
        <div id="betamount">
  ...
  static createActionPhase(table: BlackJackTable) {
    const container = document.createElement("div");
    container.innerHTML = `
  ...
  static createCardView(player: BlackJackPlayer) {
    const container = document.createElement("div");
  ...
  static faceDownCard(table: BlackJackTable) {
    const faceDownCard: string =
  ...
  static faceUpCard(table: BlackJackTable) {
    const faceUpCard: string =
      table.house.hand[0].suit + table.house.hand[0].rank;
  ...
  static createResultModal(table: BlackJackTable) {
    const container = document.createElement("div");
    container.innerHTML = `
  ...
  static createNewGameBtn(chip: number) {
    const status = chip > 0 ? "Next Round" : "New Game";
  ...
  static disabledSecondActionBtn() {
    const doubleBtn = document.getElementById("double") as HTMLInputElement;
